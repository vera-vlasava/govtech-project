  ...
  <header class="site-header"   :class="$store.state.headerBlend ? 'disableblend' : '' ">
    ...
    <div class="offcanvas"  :class="$store.state.menu ? 'active' : '' ">
      <nav>
        <ul>
          <li>
            <a href="#initiatoren" class="text-link">Initiatoren</a>
          </li>
          <li>
            <a href="#spaces" class="text-link">Spaces</a>
          </li>
          <li>
            <a href="#community" class="text-link">Community</a>
          </li>
          <li>
            <a href="#services" class="text-link">Programme & Services</a>
          </li>
          <li>
            <a href="#join" class="text-link">Mitglied werden</a>
          </li>
        </ul>
      </nav>
    </div>
